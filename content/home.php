<!-- Hero Section -->
    <section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        <?php foreach ($rowSlider as $key => $rowSlider): ?>
    ...
    <section id="about" class="about section">
      ...
      <div class="container">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200"><img src="admin/uploads/<?php echo $rowAbout['image'] ?>"></div>
    ...
    <section id="clients" class="clients section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-0 clients-wrap">
          ...
          <?php foreach ($rowClient as $key => $rowClients): ?>

            <div class="col-xl-3 col-md-4 client">
              <img src="admin/uploads/<?php echo $rowClients['image'] ?>" class="img-fluid" alt="">
            </div><!-- End Client Item -->
